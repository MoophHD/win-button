...
const img = require("assets/lvls/dir.png");

const combination = 3021;
            ...
            <Container>
                <Grid>
                    <Row style={{alignItems: 'center', justifyContent: 'space-between'}}>
                        <Note>
                            <View style={{paddingBottom: 10, flexDirection: 'column', display: 'flex', flex: 1}}>
                                <MyText style={{textAlign: 'center'}} size={55}>
                                    NEWS
                                </MyText>
                                <ImgWrapper>
                                    <Image 
